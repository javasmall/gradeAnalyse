...
layui.use(['layer', 'form'], function () {
    ...
    $(function () { //页面初始化加载
        ...
        function allSubject_getGrade() {
            var URL="http://www.overlove.xin/ssm/classlessonscore?id=100000001&lesson=语文&test=test3";
            ...
            $.ajax({
                url: "http://www.overlove.xin/ssm/classlessonscore?id="+classId+"&lesson="+allSubject_sub+"&test="+allSubject_test,//请求url
