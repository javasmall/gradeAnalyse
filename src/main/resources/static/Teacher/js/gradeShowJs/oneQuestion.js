...
layui.use(['layer', 'form'], function () {
    ...
    function oneQuestion_getsumofPerson_table() {
        var URL="http://www.biggsai.com/ssm/getproblemscore?lesson=语文&classid=100000009&index=17&test=test1";
        var testURL="http://www.biggsai.com/ssm/getproblemscore?lesson="+oneQuestion_subject+"&classid="+classId+"&index="+oneQuestion_questionNumber
