...
$(function () {
    ...
    function getJson() {
        for(var i=0;i<7;i++) { //获取所有考试的三科总成绩
            var URL="http://www.biggsai.com/ssm/studentrank?test=" +testName[i]+ "&classid="+classId;
           
            $.ajax({
                url: "http://www.biggsai.com/ssm/studentrank?test=" +testName[i]+ "&classid="+classId,	//请求url
