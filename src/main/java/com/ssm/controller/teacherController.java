...
public class teacherController {
    ...
    public boolean addtestconfig(String xueke,String testname,int score[],  String point[], String type[])
    {

        return teacherService.insearttestconfig(testname,xueke,score,point,type,"just");
